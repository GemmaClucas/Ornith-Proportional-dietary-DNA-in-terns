...
Below is the code I used to create a custom reference database using the RESCRIPt plugin. This database contains all fish 12S and mitochondrial sequences available on GenBank at the time of curation (June 2021), in addition to birds worked on in our lab as possible sources of contamination and/or amplification of host DNA.  
